  ...
  const handleSignup = async () => {
    ...
    try {
      if (step === "details") {
        ...
        setStep("otp")
        setLoading(false) // Wait for user input
      } else {
        // Verify OTP
  ...
  return (
    <AuthLayout title="Create account" subtitle="Start your Nexus workspace">
      ...
      <button
        ...
        "
      >
        {loading ? (step === "details" ? "Sending Code..." : "Verifying...") : (step === "details" ? "Send Verification Code" : "Create account")}
      </button>
